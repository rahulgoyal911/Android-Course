...
public class CounMan extends ApplicationAdapter {
	SpriteBatch batch;
	Texture background;
	Texture[] man;
	int manState =0;
	...
	public void render () {
		...
		manRectangle = new Rectangle(Gdx.graphics.getWidth()/2 - man[manState].getWidth()/2 ,manY,man[manState].getHeight(),man[manState].getHeight());
